# -*- coding: utf-8 -*-
#
# informe2 documentation build configuration file, created by
...
project = u'Informe de diseño, propuesta de fases de desarrollo, configuración y pruebas de TINJACÁ'
