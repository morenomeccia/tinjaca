...
class Propuestas(models.Model):
    ...
    codigo_garantia = fields.Char(related='tipos_garantia_id.codigo', readonly=True)
    up_empresa_establecida = fields.Boolean(related='unidades_productivas_id.empresa_establecida', readonly=True)
