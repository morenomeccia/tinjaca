...
class Solicitantes(models.Model):
    ...
    codigo_solicitud = fields.Char(string='Código de la Solicitud', required=True)
    ...
    cedula = fields.Integer(string='Cédula de Indentidad', required=True)
    rif = fields.Char(string='RIF')
    birthdate_date = fields.Date(string='Fecha de Nacimiento', default=fields.Date.today()) # de partner_contact_birthdate
